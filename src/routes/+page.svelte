...
<div>
	<section class="relative bg-cover bg-center bg-no-repeat">
		<div
			class="absolute inset-0 bg-[#2E2E2E] sm:bg-transparent sm:bg-gradient-to-r from-[#303437] to-[#202E37]"
		/>

		<div
			class="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8"
		>
			<div class="max-w-xl text-center sm:text-left text-[#CCCCCC]">
				<h1 class="text-3xl font-extrabold sm:text-5xl">SVELTEWAY</h1>

				<p class="mt-4 max-w-lg sm:text-xl sm:leading-relaxed text-[#CCCCCC]">
				...
				<div class="mt-8 flex flex-wrap gap-4 text-center">
					<a
						href="/docs"
						class="hover:underline decoration-2 decoration-white text-lg block w-full rounded bg-[#FF531A] px-12 py-3 font-medium text-white shadow hover:bg-[#FF531A] focus:outline-none active:bg-[#FF531A] sm:w-auto"
					>
						Get Started
					</a>
	...
	<div class="grid content-center justify-center p-2 bg-[#1E1E20]">
		...
		<div class="mt-5 divider text-xl font-extrabold sm:text-xl">Roadmap</div>
		<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
			<div class="card w-96 max-w-full bg-[#252529] shadow-xl">
				<div class="card-body">
					<button class="btn btn-square no-animation bg-[#1E1E20] hover:bg-[#1E1E20]">
					...
					<h2 class="card-title">SWC Component Tree</h2>
					<p style="font-size: 14px; font-weight: 500; line-height:24px">
						For consuming existing svelte components and customise styles.
					</p>
					<div class="card-actions justify-end" />
				</div>
			</div>
		...
		<div class="mt-5 grid content-center justify-center">
			<svg
				xmlns="http://www.w3.org/2000/svg"
				fill="none"
				viewBox="0 0 24 24"
		...
		<div class="mt-5 divider text-xl font-extrabold sm:text-xl">Made possible by</div>
		<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
			<div class="card w-96 max-w-full bg-[#252529] shadow-xl">
				<div class="card-body">
					<button class="btn btn-square no-animation bg-[#1E1E20] hover:bg-[#1E1E20]">
			...
			<div class="card w-96 max-w-full bg-[#252529] shadow-xl">
				<div class="card-body">
					...
					<div class="card-actions justify-start">
						<a class="btn btn-info mt-5" href="https://tailwindcss.com/" target="_blank">View</a>
					</div>
				</div>
			</div>
			<div class="card w-96 max-w-full bg-[#252529] shadow-xl">
				<div class="card-body">
					...
					<div class="card-actions justify-start">
						<a class="btn btn-info mt-5" href="https://daisyui.com/" target="_blank">View</a>
					</div>
				</div>
			</div>
		</div>
