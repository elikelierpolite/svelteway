...
import { v4 as uuidv4 } from 'uuid';
	...
	import Checkbox1 from './mainComponents/Checkbox1.svelte';
...
<div class="w-full flex flex-col gap-7 justify-center mb-10">
	...
	>
		<div class="form-control w-52">
			<label class="cursor-pointer label">
				<span class="label-text">Remember me</span>
				<input type="checkbox" checked={true} class="checkbox checkbox-secondary" />
			</label>
		</div>
	</div>
	<div
	...
	>
		<div class="form-control w-52">
			<label class="cursor-pointer label">
				<span class="label-text">Remember me</span>
				<input type="checkbox" checked={true} class="checkbox checkbox-warning" />
			</label>
		</div>
	</div>
	<div
	...
	>
		<div class="form-control w-52">
			<label class="cursor-pointer label">
				<span class="label-text">Remember me</span>
				<input type="checkbox" checked={true} class="checkbox checkbox-info" />
			</label>
		</div>
	</div>
	<div
	...
	>
		<div class="flex flex-col items-center gap-2">
			...
			<input type="checkbox" checked={true} class="checkbox checkbox-md" />
			<input type="checkbox" checked={true} class="checkbox checkbox-lg" />
		</div>
	</div>
	<div
		class="preview border-base-300 bg-base-200 rounded-b-box rounded-tr-box flex min-h-[6rem] min-w-[18rem] max-w-4xl flex-wrap items-center justify-center gap-2 overflow-x-hidden border bg-cover bg-top p-4 hover:cursor-pointer"
